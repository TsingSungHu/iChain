...
import com.qs.iChain.context.ContextNameDefineException;
...
public class ContextUtil {
    ...
    private static void initDefaultContext() {
        ...
        EntranceNode node = new EntranceNode(defaultContextName);
    ...
    static void resetContextMap() {
        if (contextNameNodeMap != null) {
            log.warn("Context map cleared and reset to initial state");
     ...
     * </p>
     * <p>
     * A context will be bound with an {@link EntranceNode}, which represents the entrance node
    ...
    private static void setNullContext() {
        ...
        if (shouldWarn) {
            log.warn("[StatusChecker] WARN: Amount of context exceeds the threshold "
